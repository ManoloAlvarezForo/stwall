...
/**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      * Gets All events.
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      */
var getEvents = /*#__PURE__*/function () {var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (
              _event["default"].find({}));case 2:return _context.abrupt("return", _context.sent);case 3:case "end":return _context.stop();}}}, _callee);}));return function getEvents() {return _ref.apply(this, arguments);};}();
...
var getEventsByMonth = /*#__PURE__*/function () {var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(
  month,
  year,
  locale,
  daysPerMonth) {var calendarUtil, from, to, response, auxDate, dayAux;return regeneratorRuntime.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:
            ...
            from = calendarUtil.startDate;
            to = calendarUtil.endDate;
            response = [];case 4:if (

            (0, _moment["default"])(from).isAfter(to)) {_context3.next = 12;break;}_context3.next = 7;return (
              _event["default"].find({ date: from.format('YYYY-MM-DD') }));case 7:auxDate = _context3.sent;
            if (auxDate.length !== 0) {
              dayAux = { date: from.format('YYYY-MM-DD'), events: [] };
              dayAux.events = dayAux.events.concat(auxDate);
              response.push(dayAux);
            }

            from.add(1, 'days');_context3.next = 4;break;case 12:return _context3.abrupt("return",
